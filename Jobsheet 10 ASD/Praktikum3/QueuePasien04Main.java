...
public class QueuePasien04Main {
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
        System.out.print("Masukkan kapasitas antrian: ");
        int capacity = sc.nextInt();
        QueuePasien04 antrian = new QueuePasien04(capacity);
        ...
        do {
            ...
            switch (pilihan) {
                case 1:
                    ...
                    Pasien04 pb = new Pasien04(nama, noID, jenisKelamin, umur);
                    sc.nextLine();
                    antrian.enqueue(pb);
                    break;
                case 2:
                    Pasien04 pasienHapus = antrian.dequeue();
                    if (pasienHapus != null) {
